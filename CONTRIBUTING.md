# **Cars Point cloud to Mesh** **Contributing guide**.
...
Any proven or suspected malfunction should be traced in a bug report, the latter being an issue in the Cars Point cloud to Mesh repository.
...
Cars Point cloud to Mesh requires that contributors sign out a [Contributor License
...
To accept your contribution, we need you to get from CS team (ospo@cs-soprasteria.com), complete, sign and send to CS 3D dev team :
* an Individual Contributor Licensing Agreement (ICLA) form
* a Corporate Contributor Licensing Agreement (CCLA) form if you are contributing on behalf of your company or another entity which retains copyright for your contribution.

...
from cars_point_cloud_to_mesh.applications.holes_detection import holes_detection_tools
from cars_point_cloud_to_mesh.applications.holes_detection.holes_detection import HolesDetection
